...
public class Listings {
    ...
    public static List<Flights> randomFlightlist(String date, String origin, String destination, int distance){
        ...
        list.add(new Flights(date,Integer.toString(startTime[0]),"Eva",origin,destination,Integer.toString(price),Integer.toString(flight)));
        list.add(new Flights(date,Integer.toString(startTime[1]),"Emirates",origin,destination,Integer.toString(price),Integer.toString(flight)));
        list.add(new Flights(date,Integer.toString(startTime[2]),"Hannel",origin,destination,Integer.toString(price),Integer.toString(flight)));
